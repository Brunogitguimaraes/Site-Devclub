...
const repoName = process.env.GITHUB_REPOSITORY?.split('/')[1] || 'Projeto-Devclub';
...
export default defineConfig({
	// Netlify serves the site from the domain root. Only GitHub Pages needs the
	// repository name as a URL prefix.
	...
	build: {
		// Keep all app builds in one predictable monorepo output directory.
		// This must stay aligned with netlify.toml and the GitHub Pages workflow.
